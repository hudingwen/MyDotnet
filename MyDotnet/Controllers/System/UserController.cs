...
namespace MyDotnet.Controllers.System
{
    ...
    public class UserController : BaseApiController
    {
        ...
        public async Task<MessageModel<PageModel<SysUserInfoDto>>> Get(int page = 1, string key = "")
        {
            ...
            var data = await _sysUserInfoServices.Dal.QueryPage(a => a.IsDeleted != true && a.Status >= 0 && (a.LoginName != null && a.LoginName.Contains(key) || a.RealName != null && a.RealName.Contains(key)), page, intPageSize, " Id desc ");
        ...
        public async Task<MessageModel<string>> Post([FromBody] SysUserInfoDto sysUserInfo)
        {
            ...
            var id = await _sysUserInfoServices.Dal.Add(_mapper.Map<SysUserInfo>(sysUserInfo));
            data.success = id > 0;
            if (data.success)
            {
        ...
        public async Task<MessageModel<string>> Put([FromBody] SysUserInfoDto sysUserInfo)
        {
            ...
            var oldUser = await _sysUserInfoServices.Dal.QueryById(sysUserInfo.uID);
            ...
            try
            {
                ...
                data.success = await _sysUserInfoServices.Dal.Update(oldUser);

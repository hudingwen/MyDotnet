...
namespace MyDotnet.Repository.System
{
    /// <summary>
    /// 权限关系仓储类
    /// </summary>	
    public class RoleModulePermissionRepository : BaseRepository<RoleModulePermission>
    {
        /// <summary>
        /// 权限构造函数
        /// </summary>
        /// <param name="unitOfWorkManage"></param>
        public RoleModulePermissionRepository(UnitOfWorkManage unitOfWorkManage) : base(unitOfWorkManage)
        {
        }
